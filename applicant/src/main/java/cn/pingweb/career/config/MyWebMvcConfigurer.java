...
//    private CrossFieldInterceptor crossFieldInterceptor;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(applicantInterceptor).addPathPatterns("/user/*")
                .addPathPatterns("/resume/**");
        registry.addInterceptor(loginInterceptor).addPathPatterns("/job/*").excludePathPatterns("/job/index");
