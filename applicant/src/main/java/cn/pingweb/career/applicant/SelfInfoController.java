...
public class SelfInfoController {
    ...
    public VO saveSkill(@RequestParam("param1") String name,
                        ...
                        @RequestParam("param3") String degree,
        ...
        BaseInfo baseInfo = new BaseInfo(userId, name, gender,birthday, phone, email, EducationDegree.getDegreeNameByValue(degree), workYear);
